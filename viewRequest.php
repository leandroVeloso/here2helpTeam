        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <div class="row control-group">
                        <div class="form-group col-xs-8 label-form-group controls">
                            ...
                            <select class="form-control" id="serviceID" disabled name="serviceID" required>
                                <?php
                                       echo "<option value='".$myRequest['serviceID']."'>".$myRequest['service']."</option>";
                                ?>
                            </select>
                                  <p class="help-block text-danger"></p>
                        </div>
                    ...
                    <div class="row control-group">
                        <div class="form-group col-xs-8 label-form-group controls">
                            ...
                            <select class="form-control" id="priorityID" disabled name="priorityID" required>
                                <?php
                                       echo "<option value='".$myRequest['priorityID']."'>".$myRequest['priority']."</option>";
                                ?>
                            </select>
                                  <p class="help-block text-danger"></p>
                        </div>
                    ...
                    <div class="row control-group">
                        ...
                        <div class="control col-xs-4">
                            ...
                            <div class="input-group">
                                <input id="startDate" type="text" disabled  placeholder="Start Date" value="<?php echo $myRequest['startDate'];?>" required  name="startDate" class="date-picker form-control" />
                            ...
                            <div class="input-group">
                                <input id="endDate" type="text" disabled placeholder="End Date" required value="<?php echo $myRequest['endDate'];?>" name="endDate" class="date-picker form-control" />
                    ...
                    <div id="adressForm">
                        <div class="checkbox">
                      <label><input type="checkbox" value="yes" onclick="return false" name="addressCheckBox" <?php if($myRequest['locationID'] == $myRequest['addressID']) echo "checked";?> id="addressCheckBox">Use my account address</label>
                    </div>
                        <div class="row control-group">
                                <div class="form-group col-xs-4 label-form-group controls">
                                ...
                                <div class="form-group col-xs-4 label-form-group controls">
                                    <label>State</label>
                                      <select class="form-control" id="state" disabled name="state" >
                                        <?php
                                            echo "<option value='".$myRequest['state']."'>".$myRequest['state']."</option>";
                                        ?>
                                      </select>
                                      <p class="help-block text-danger"></p>
                                </div>
