                    ...
                    <div class="row control-group">
                        ...
                        <div class="control col-xs-4">
                            ...
                            <div class="input-group">
                                <input id="startDate" type="text"   placeholder="Start Date" value="<?php echo $myRequest['startDate'];?>" required  name="startDate" class="date-picker form-control" />
                            ...
                            <div class="input-group">
                                <input id="endDate" type="text"  placeholder="End Date" required value="<?php echo $myRequest['endDate'];?>" name="endDate" class="date-picker form-control" />
                    ...
                    <div id="adressForm" <?php if($myRequest['locationID'] == $myRequest['addressID']) echo 'style="display: none;"';?>>
                        <div class="row control-group">
                                <div class="form-group col-xs-4 label-form-group controls">
                                    ...
                                    <input type="text" maxlength="10" onkeypress="return isNumber(event)"value='<?php echo $myRequest['unitNumber'];?>'   class="form-control" placeholder="Unit Number" id="unumber" name="unumber" data-validation-required-message="Please enter your unit number.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="row control-group">
                                <div class="form-group col-xs-12 label-form-group controls">
                                    <label>Street</label>
                                    <input type="text" class="form-control" maxlength="50" placeholder="Street" value='<?php echo $myRequest['street'];?>'   id="street" name="street" data-validation-required-message="Please enter your street name.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="row control-group">
                                <div class="form-group col-xs-12 label-form-group controls">
                                    <label>Suburb</label>
                                    <input type="text" class="form-control" maxlength="50" placeholder="Suburb" value='<?php echo $myRequest['suburb'];?>'  id="suburb" name="suburb" data-validation-required-message="Please enter your suburb.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="row control-group">
                            ...
                            <div class="row control-group">
                                <div class="form-group col-xs-4 label-form-group controls">
                                    ...
                                    <input type="text" onkeypress="return isNumber(event)"  maxlength="4" value='<?php echo $myRequest['postcode'];?>' class="form-control" placeholder="Postcode" id="postcode"name="postcode" data-validation-required-message="Please enter your post code.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                        </div>
