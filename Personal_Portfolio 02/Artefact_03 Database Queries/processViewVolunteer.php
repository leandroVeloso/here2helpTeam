<?php
  ...
  function viewVolunteerDetails(){
    ...
    try{
      $volunteerDetails = $pdo -> prepare('SELECT U.userID, U.firstName, U.lastName, U.email, U.phoneNo, A.unitNumber, A.street, A.suburb, A.state, A.postcode, U.lastModified, U.typeID
                                        FROM USER U
